...
import 'package:final5/controllers/login_controller.dart';
import 'package:final5/controllers/registration_controller.dart';
import 'package:final5/widgets/input_fields.dart';
import 'package:final5/widgets/submit_button.dart';
...
class _AuthScreenState extends State<AuthenticationScreen> {
  ...
  Widget registerWidget() {
    return Column(
      children: [
        InputTextFieldWidget(registerationController.firstNameController, 'firstName'),
        SizedBox(
          height: 20,
        ),
        InputTextFieldWidget(registerationController.lastNameController, 'lastName'),
        SizedBox(
          height: 20,
        ),
