import 'package:final5/example/app_colors.dart';
...
class PaymentScreen extends StatefulWidget {
  ...
  const PaymentScreen({super.key,required this.ID,required this.UID,required this.name});
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      darkTheme: ThemeData(
        ...
        // Decoration theme for the text fields.
        inputDecorationTheme: InputDecorationTheme(
          hintStyle: const TextStyle(color: Color.fromARGB(255, 70, 69, 69)),
          labelStyle:
              const TextStyle(color: Color.fromARGB(255, 203, 196, 196)),
          focusedBorder: border,
          enabledBorder: border,
        ),
      ),
  ...
  void _onValidate() {
    if (formKey.currentState?.validate() ?? false) {
      print('valid!');
      Get.to(MDetails(ID: widget.ID, name: widget.name, UID: widget.UID));
    } else {
      print('invalid!');
    }
  }
